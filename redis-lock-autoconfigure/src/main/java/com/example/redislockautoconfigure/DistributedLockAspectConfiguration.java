...
import com.example.redislockautoconfigure.annotations.LockAction;
...
public class DistributedLockAspectConfiguration {
    ...
    @Pointcut("@annotation(com.example.redislockautoconfigure.annotations.LockAction)")
